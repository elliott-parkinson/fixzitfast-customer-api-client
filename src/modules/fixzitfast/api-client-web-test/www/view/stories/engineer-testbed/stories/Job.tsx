    ...
    export class Pane extends React.Component<any>
    {
        ...
        render() {
            return <Container>
                ...
                <Alert color="info">Get details</Alert>
                <Alert color="info">Start</Alert>
                <Alert color="info">Finish</Alert>
                <Alert color="info">Rechedule</Alert>
                <Alert color="info">Get Payment person</Alert>
                <Alert color="info">Get checklist</Alert>
            </Container>;
        }
    }
}